...
// ====== رمز سجل الآليات: آلية إطفاء الدفاع المدني (مفرّغة الخلفية) ======
const VEH_ICON = "data:image/png;base64,";

// رمز الآلية كعنصر: ارتفاعه 1em فيطابق حجم الإيموجي المجاور في أي سياق
const VIcon = ({ s: sz }) => (
  <img src={VEH_ICON} alt="" style={{
...
// ====== مكتبة أشكال بصرية: نصوص لا تتداخل وتنوّع بالتصميم ======
// (1) صف ترتيبي بشريط تعبئة — للقوائم المرتبة
function RankRow({ i, name, sub, value, unit, pct, color, onClick, badge }) {
  return (
    <div onClick={onClick} style={{
      display: "flex", alignItems: "center", gap: 11, padding: "9px 11px", borderRadius: 13,
      background: i % 2 ? "#FAFBFC" : "#fff", border: "1px solid #EDEFF3", cursor: onClick ? "pointer" : "default",
    }}>
      <span style={{
        width: 26, height: 26, borderRadius: 9, flexShrink: 0, display: "inline-flex", alignItems: "center",
        justifyContent: "center", fontSize: 11.5, fontWeight: 800,
        background: i < 3 ? color : "#EEF0F4", color: i < 3 ? "#fff" : "#6B7385",
      }}>{i + 1}</span>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: 12.5, fontWeight: 800, color: "#1B2130", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{name}</div>
        {sub && <div style={{ fontSize: 10, fontWeight: 700, color: "#8B93A3", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginTop: 1 }}>{sub}</div>}
        <div style={{ height: 6, background: "#EFF1F5", borderRadius: 5, marginTop: 5, overflow: "hidden" }}>
          <div style={{ width: Math.max(3, Math.min(100, pct)) + "%", height: "100%", background: color, borderRadius: 5 }} />
        </div>
      </div>
      <div style={{ textAlign: "center", flexShrink: 0, minWidth: 52 }}>
        <div style={{ fontSize: 15, fontWeight: 800, color: color, lineHeight: 1.1 }}>{value}</div>
        {unit && <div style={{ fontSize: 9, fontWeight: 800, color: "#9AA2B1" }}>{unit}</div>}
        {badge}
      </div>
    </div>
  );
}
// (2) مقياس نصف دائري — للنِسب المفردة
function GaugeArc({ pct, color, label, sub, size = 190 }) {
  const R = 74, CX = size / 2, CY = size / 2 + 14;
  const a = Math.PI * (1 - Math.max(0, Math.min(100, pct)) / 100);
  const x2 = CX + R * Math.cos(a), y2 = CY - R * Math.sin(a);
  const big = pct > 50 ? 1 : 0;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      <svg viewBox={`0 0 ${size} ${size * 0.66}`} style={{ width: "100%", maxWidth: size + 30 }}>
        <path d={`M ${CX - R} ${CY} A ${R} ${R} 0 0 1 ${CX + R} ${CY}`} fill="none" stroke="#EFF1F5" strokeWidth="15" strokeLinecap="round" />
        <path d={`M ${CX - R} ${CY} A ${R} ${R} 0 ${big} 1 ${x2} ${y2}`} fill="none" stroke={color} strokeWidth="15" strokeLinecap="round" />
        <text x={CX} y={CY - 16} textAnchor="middle" style={{ fontSize: 30, fontWeight: 800, fill: color, fontFamily: "inherit" }}>{pct}%</text>
        <text x={CX} y={CY + 4} textAnchor="middle" style={{ fontSize: 11, fontWeight: 800, fill: "#8B93A3", fontFamily: "inherit" }}>{label}</text>
      </svg>
      {sub && <div style={{ fontSize: 11.5, fontWeight: 700, color: "#5A6172", textAlign: "center", marginTop: 2 }}>{sub}</div>}
    </div>
  );
}
// (3) شريط مكدّس أفقي بمفتاح أسفله — للتوزيعات
function StackBar({ items, total }) {
  const T = total || items.reduce((a, b) => a + b.n, 0) || 1;
  return (
    <div>
      <div style={{ display: "flex", height: 30, borderRadius: 10, overflow: "hidden", border: "1px solid #E7E9EE" }}>
        {items.map((s, i) => (
          <div key={i} title={`${s.name}: ${s.n}`} style={{ width: (s.n / T) * 100 + "%", background: s.color, position: "relative" }}>
            {(s.n / T) > 0.12 && (
              <span style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 11, fontWeight: 800 }}>
                {Math.round((s.n / T) * 100)}%
              </span>
            )}
          </div>
        ))}
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(140px,1fr))", gap: 7, marginTop: 12 }}>
        {items.map((s, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 7, background: "#F8F9FB", border: "1px solid #EDEFF3", borderRadius: 10, padding: "6px 9px" }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 800, color: "#3A4152", flex: 1, minWidth: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{s.name}</span>
...
// (4) شبكة خلايا حالة — للبنود المتوفرة/الناقصة
function StatusGrid({ items, min = 128 }) {
  return (
...
// (9) حلقة مجزأة + قائمة جانبية — الهوية البصرية المعتمدة للمؤشرات البسيطة
function RingBreakdown({ items, centerValue, centerLabel, emptyText }) {
  const list = (items || []).filter((x) => x && x.n >= 0);
  const tot = list.reduce((a, b) => a + b.n, 0) || 1;
  if (!list.length) return <div style={{ padding: 14, fontWeight: 700, color: "#5A6172" }}>{emptyText || "لا بيانات."}</div>;
    ...
    <div style={{ display: "flex", gap: 18, alignItems: "center", flexWrap: "wrap" }}>
      <div style={{ flex: "0 0 auto", position: "relative", width: 180, height: 180, margin: "0 auto" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          <div style={{ fontSize: 27, fontWeight: 800, color: "#1B2130", lineHeight: 1 }}>{centerValue}</div>
          <div style={{ fontSize: 10.5, fontWeight: 800, color: "#8B93A3", marginTop: 2, textAlign: "center", padding: "0 12px", lineHeight: 1.3 }}>{centerLabel}</div>
        </div>
      </div>
      <div style={{ flex: 1, minWidth: 210, display: "flex", flexDirection: "column", gap: 7, maxHeight: 250, overflowY: "auto" }}>
        {list.map((s, i) => (
  ...
  const C = ({ n, label, color, icon, go, sub, pctOf, pctNote }) => {
    ...
    return (
      <div onClick={() => go && onGo(go)} style={{ background: "#fff", borderRadius: 20, padding: "20px 22px", flex: "1 1 170px", border: "1px solid #E4E7F0", boxShadow: "0 10px 30px rgba(20,26,40,0.08)", cursor: go ? "pointer" : "default", transition: "transform 0.15s" }}
        ...
        {pctOf > 0 && (
          <div style={{ fontSize: 11.5, fontWeight: 800, color: color, marginTop: 4, background: color + "14", borderRadius: 8, padding: "2px 8px", display: "inline-block" }}>
            نسبة {Math.round((n / pctOf) * 100)}%{pctNote ? " " + pctNote : ""}
          </div>
        )}
    ...
    <div style={{ maxWidth: 1080, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
        {[["📋", "الجاهزية الميدانية", "تغطية المراكز الميدانية الـ62 لحظياً", "readiness"],
          [<VIcon key="v" />, "سجل الآليات", `${S.total} آلية ببياناتها وأعطالها وسجلها الزمني`, "list"],
...
function WelcomeTour({ onDone }) {
  ...
  const steps = [
    ...
    [<VIcon key="v" />, "سجل الآليات", "سجل كامل بكل آلية: الحالة، الموقع، الأعطال وتواريخها، وخط زمني لكل آلية."],
    ...
    <ChartCard title="أطول الآليات توقفاً بسبب الأعطال" icon="⏳" grad="linear-gradient(90deg, #7A1016, #E3A008)">
      {data.rows.length === 0 ? (
        ...
        <div style={{ padding: "16px 18px 18px" }}>
          {/* الشرائح الزمنية كأعمدة زجاجية — النقر يفتح تفاصيلها */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(112px,1fr))", gap: 9, marginBottom: 14 }}>
            {data.bands.map((b) => {
              const share = data.rows.length ? Math.round((b.list.length / data.rows.length) * 100) : 0;
              const on = openBand === b.k;
              return (
                <div key={b.k} onClick={() => setOpenBand(on ? null : b.k)} style={{
                  cursor: "pointer", borderRadius: 15, padding: "11px 12px", textAlign: "center",
                  background: on ? b.c : "#FBFCFD", border: "2px solid " + (on ? b.c : "#EAECF1"),
                  boxShadow: on ? "0 8px 20px " + b.c + "40" : "none", transition: "all .15s ease",
                }}>
                  <div style={{ fontSize: 22, fontWeight: 800, color: on ? "#fff" : b.c, lineHeight: 1.1 }}>{b.list.length}</div>
                  <div style={{ fontSize: 10.5, fontWeight: 800, color: on ? "rgba(255,255,255,0.92)" : "#6B7385", marginTop: 3, lineHeight: 1.4 }}>{b.k}</div>
                  <div style={{ height: 5, background: on ? "rgba(255,255,255,0.28)" : "#EFF1F5", borderRadius: 4, marginTop: 7, overflow: "hidden" }}>
                    <div style={{ width: share + "%", height: "100%", background: on ? "#fff" : b.c, borderRadius: 4 }} />
                  </div>
                  <div style={{ fontSize: 9.5, fontWeight: 800, color: on ? "rgba(255,255,255,0.9)" : "#9AA2B1", marginTop: 4 }}>{share}% من المتوقفة</div>
                </div>
              );
            })}
          </div>
          ...
          {/* شريط ملخص */}
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", background: "#FFF8EC", border: "1px solid #F0DFBB", borderRadius: 13, padding: "9px 13px", marginBottom: 14 }}>
            <span style={{ fontSize: 11.5, fontWeight: 800, color: "#7A5209" }}>⏳ الأقدم توقفاً</span>
            <span style={{ fontSize: 12, fontWeight: 800, color: "#3A2A05" }}>{data.rows[0].v.type} — {data.rows[0].v.plate}</span>
            <span style={{ fontSize: 12, fontWeight: 800, color: "#B3121C", background: "#fff", border: "1px solid #F0C6C9", borderRadius: 8, padding: "2px 10px" }}>{fmt(data.rows[0].days)}</span>
            <span style={{ marginRight: "auto", fontSize: 11.5, fontWeight: 800, color: "#7A5209" }}>إجمالي المتوقفة {data.rows.length} آلية</span>
          </div>

          {openBand && (
            <div style={{ background: "#F9FAFB", border: "1px solid #E7E9EE", borderRadius: 14, padding: "10px 12px", marginBottom: 14, maxHeight: 240, overflowY: "auto" }}>
              {(data.bands.find((b) => b.k === openBand) || { list: [] }).list.slice(0, 40).map((r, i) => (
                <div key={r.v.id} style={{ display: "flex", gap: 9, alignItems: "center", padding: "6px 4px", borderBottom: "1px dashed #E7E9EE" }}>
                  <span style={{ fontSize: 10.5, fontWeight: 800, color: "#9AA2B1", minWidth: 18 }}>{i + 1}</span>
                  <span style={{ flex: 1, minWidth: 0, fontSize: 11.5, fontWeight: 800, color: "#1B2130", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{r.v.type} — {r.v.plate}</span>
                  <span style={{ fontSize: 11, fontWeight: 800, color: "#B3121C", whiteSpace: "nowrap" }}>{fmt(r.days)}</span>
                </div>
              ))}
            </div>
          )}

          {/* أطول 15 آلية — صفوف ترتيبية بشريط نسبي */}
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            {top.map((r, i) => {
              const maxD = top[0].days || 1;
              const band = data.bands.find((b) => (b.list || []).some((x) => x.v.id === r.v.id));
              const clr = band ? band.c : "#B3121C";
              return (
                <RankRow key={r.v.id} i={i} color={clr}
                  name={`${r.v.type} — ${r.v.plate}`}
                  sub={`${r.v.unit || "بلا جهة"} · ${r.v.location || "المقر"}`}
                  value={fmt(r.days)} pct={(r.days / maxD) * 100} />
              );
            })}
          </div>
        </div>
...
function InteractiveDashboard({ vehicles, counts, faultStats, centerReadiness, equip, supportCounts, prio, prioWeights, incidents }) {
  ...
  const rdy = useMemo(() => {
    ...
    const RISK_SKIP = ["مجد 3", "وصفا 6"]; // مستبعدان من إحصائية عجز التغطية بقرار الإدارة
    const topRisk = compass.filter((x) => x.risk > 0 && !RISK_SKIP.some((s) => (x.name || "").includes(s))).slice(0, 10)
    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 980, margin: "0 auto", width: "100%" }}>
          ...
          <div style={{ padding: "18px 18px 20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(104px,1fr))", gap: 8, marginTop: 16 }}>
              {[["✅", "جاهزة", counts["تعمل"] + counts["تم الإصلاح"], "#00875A"],
                ...
                <div key={nm} style={{ background: c + "0F", border: "1.5px solid " + c + "33", borderRadius: 14, padding: "10px 8px", textAlign: "center" }}>
                  <div style={{ fontSize: 15 }}>{ic}</div>
                  <div style={{ fontSize: 19, fontWeight: 800, color: c, lineHeight: 1.15, marginTop: 2 }}>{n}</div>
                  <div style={{ fontSize: 10.5, fontWeight: 800, color: "#5A6172", marginTop: 1 }}>{nm}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <ChartCard title="توزيع الأعطال حسب النوع" icon="🔩" grad="linear-gradient(120deg,#B45309,#FFB800)">
          <div style={{ padding: "18px 18px 20px" }}>
            {(() => {
              ...
              return (
                <div>
                  <StackBar items={items} total={tot} />
                  <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 14 }}>
                    {items.slice(0, 5).map((s, i) => (
                      <RankRow key={s.name} i={i} color={s.color} name={s.name}
                        value={s.n} unit="عطل" pct={(s.n / items[0].n) * 100}
                        sub={`${Math.round((s.n / tot) * 100)}% من إجمالي الأعطال`} />
                    ))}
                  </div>
                </div>
              );
        ...
        <ChartCard title="أكثر الجهات آليات عطلانة (حالياً)" icon="🏢" grad="linear-gradient(120deg,#C4353C,#FF7A00)">
          <div style={{ padding: "16px 18px 20px" }}>
            {(() => {
              const rows = (unitFaultData || []).slice(0, 10);
              if (!rows.length) return <div style={{ padding: 14, fontWeight: 700, color: "#5A6172" }}>لا توجد آليات عطلانة.</div>;
              const key = Object.keys(rows[0]).find((k) => k !== "name");
              const max = rows[0][key] || 1;
              const totalBroken = rows.reduce((a, b) => a + b[key], 0);
              return (
                <div>
                  <div style={{ display: "flex", gap: 9, flexWrap: "wrap", marginBottom: 13 }}>
                    <span style={{ fontSize: 11.5, fontWeight: 800, color: "#8E1A22", background: "#FCEEEF", border: "1px solid #F2C3C6", borderRadius: 10, padding: "6px 12px" }}>
                      أعلى {rows.length} جهات · مجموع متعطلاتها {totalBroken} آلية
                    </span>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    {rows.map((r, i) => (
                      <RankRow key={r.name} i={i} color={i < 3 ? "#B3121C" : i < 6 ? "#D4622A" : "#C77F1A"}
                        name={r.name} value={r[key]} unit="آلية" pct={(r[key] / max) * 100} />
                    ))}
                  </div>
                </div>
              );
        ...
        <ChartCard title="أكثر أنواع الآليات أعطالاً" icon={<VIcon />} grad="linear-gradient(120deg,#1F4E8C,#00A8E8)">
          <div style={{ padding: "18px 18px 20px" }}>
            {(() => {
        ...
        <ChartCard title="الموديلات الأكثر تعطلاً" icon="🏷" grad="linear-gradient(120deg,#4E3D80,#7C5CFF)">
          <div style={{ padding: "18px 18px 20px" }}>
            {(() => {
              ...
              const tot = items.reduce((a, b) => a + b.n, 0);
              return <RingBreakdown items={items} centerValue={tot} centerLabel="عطل بأعلى الموديلات" emptyText="لا أعطال مسجلة." />;
            })()}
          </div>
        </ChartCard>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(228px,1fr))", gap: 10, maxWidth: 980, margin: "0 auto 18px", width: "100%" }}>
        {[
          ...
          { l: "أنواع الإسناد الجاهزة", v: rdy.supportReady, of: SUPPORT_SLOTS.length, c: "#0B5F8A", bg: "#EAF4FA", bd: "#BFDCEC", ic: <VIcon />, },
          ...
          <div style={{ padding: "18px 18px 20px" }}>
            {(() => {
              ...
              if (!rows.length) return (
                <div style={{ textAlign: "center", padding: "40px 20px", fontSize: 13, fontWeight: 700, color: "#5A6172" }}>
...
function ReportsPage({ vehicles, logo, centerReadiness, equip, supportCounts, prio, prioWeights, initialMode, ro, isOwner, archive, onArchive, incidents, cohort, onCohort }) {
  ...
  const [ovf, setOvf] = useState(false); // التقرير أعرض من الشاشة فعلاً
  ...
  useEffect(() => {
    if (!isNarrow) { setFitZ(1); setOvf(false); return; }
    const calc = () => {
      const el = fitRef.current;
      if (!el) return;
      const tbl = el.querySelector("table");
      if (!tbl) { setFitZ(1); setOvf(false); return; } // تقرير بلا جدول: لا تصغير إطلاقاً
      const prev = el.style.zoom;
      el.style.zoom = "1";
      const need = Math.max(el.scrollWidth, tbl.scrollWidth), have = (el.parentElement || el).clientWidth;
      el.style.zoom = prev;
      const over = need > 0 && have > 0 && need > have * 1.02; // هامش تسامح 2%
      setOvf(over);
      setFitZ(over && fitW ? Math.max(0.28, Math.round((have / need) * 100) / 100) : 1);
    };
  ...
  const buildWa = (ck) => {
    ...
    if (ck.veh) {
      ...
      L.push(`*${ord[sec++]} — الموقف العام للآليات:*`,
        ...
        `عدد الآليات الجاهزة للعمل: *${readyWork}* ✅`,
        `عدد الآليات التي تعمل بوجود ملاحظات: *${notes}* 📋`,
        `عدد الآليات العطلانة: *${brokenN}* ⚠️`,
        `- المتعطلة بالصيانة عدد ${wshop} آلية`,
        `- المتوقفة بالمراكز عدد ${brokenN - wshop} آلية`,
    ...
    if (ck.ops) {
      ...
      L.push(`*${ord[sec++]} — الحوادث والبلاغات اليومية:*`,
        ...
        `حوادث الإطفاء عدد ${c("حادث إطفاء")}`,
        `حوادث الإنقاذ عدد ${c("حادث إنقاذ")}`,
        `أعمال الإسعاف عدد ${c("أعمال إسعاف")}`,
        `بلاغات أخرى عدد ${oth}`,
        `بلاغات انقطاع التيار الكهربائي عدد ${outage}`,
        "",
        `الإصابات في حوادث الدفاع المدني عدد *${sum(cd, "inj")}*`,
        `الوفيات في حوادث الدفاع المدني عدد *${sum(cd, "dth")}*`,
        `الإصابات في البلاغات المرورية عدد *${sum(traffic, "inj")}*`,
        `الوفيات في البلاغات المرورية عدد *${sum(traffic, "dth")}*`, "");
    }
    if (ck.rdy) {
      const cr = centerReadiness || {};
      const eq = equip || {};
      ...
      L.push(`*${ord[sec++]} — الجاهزية الميدانية:*`,
        `🟢 المراكز الميدانية مكتملة الجاهزية عدد *${g}* مركزاً`,
        `🟡 المراكز الميدانية التي بها عجز جزئي عدد *${y}* مركزاً`,
        `- عجز في آليات الإطفاء عدد ${dFire}`,
        `- عجز في آليات الإنقاذ عدد ${dRes}`,
        `- عجز في آليات نوعية أخرى عدد ${dOth}`);
      if (dFire + dRes + dOth > y) L.push(`_قد يجتمع بالمركز الواحد أكثر من سبب_`);
      L.push(`🔴 المراكز الميدانية التي بها عجز كلي عدد *${r}* مركزاً`, "");
    }
    if (ck.att) {
      const now = t.y * 354.367 + (t.m - 1) * 29.53 + t.d;
      let y1 = 0, m6 = 0, m3 = 0;
      ...
      const WA_SKIP = ["سلالم|بيرس", "سنوركل"]; // مستثناة من رسالة الواتساب فقط
      const nawiDown = [];
      NAWI_COLS.forEach((col) => {
        if (WA_SKIP.includes(col.n)) return;
      ...
      L.push(`*${ord[sec++]} — ملاحظات هامة:*`,
        `عدد الآليات المتعطلة منذ فترة زمنية طويلة *${y1 + m6 + m3}* آلية`,
        `- متوقفة أكثر من سنة عدد ${y1} آلية`,
        `- متوقفة أكثر من ستة أشهر عدد ${m6} آلية`,
        `- متوقفة أكثر من ثلاثة أشهر عدد ${m3} آلية`,
        "",
        `عدد الآليات النوعية الهامة المتوقفة عن العمل *${nawiTotal}* آلية`);
      nawiDown.forEach(([nm, n]) => L.push(`- ${nm} عدد ${n}`));
  ...
  return (
    <div>
          ...
          <div className="modal-overlay no-print" style={{ position: "fixed", inset: 0, background: "rgba(15,17,26,0.62)", zIndex: 880, display: "flex", alignItems: "center", justifyContent: "center" }} onClick={() => setWaOpen(false)}>
            <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 20, padding: "22px 24px", width: 520, maxWidth: "94%", maxHeight: "88vh", overflowY: "auto", boxShadow: "0 26px 80px rgba(0,0,0,0.45)" }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 12 }}>
                {[["veh", <span key="v"><VIcon /> الآليات</span>], ["ops", "📟 الحوادث والبلاغات اليومية"], ["rdy", "📋 الجاهزية الميدانية"], ["att", "📌 ملاحظات هامة"]].map(([k, lbl]) => (
      ...
      <div className="no-print scroll-hint" style={{ display: ovf ? undefined : "none", gap: 8, alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", fontSize: 11.5, fontWeight: 800, color: "#5A6172", background: "#EEF2F8", border: "1px solid #D3DDEA", borderRadius: 10, padding: "7px 10px", marginBottom: 8 }}>
        <span>{fitW && fitZ < 1 ? `📐 مُلائم لعرض الشاشة (${Math.round(fitZ * 100)}%) — قرّب بإصبعيك للقراءة` : "↔️ اسحب الجدول يميناً ويساراً لعرض بقية الأعمدة"}</span>
      ...
      <div id="print-area" ref={fitRef} style={{
        ...
        padding: ovf && fitW && fitZ < 1 ? "18px 12px" : "26px 30px", position: "relative",
        overflowX: ovf && fitW && fitZ < 1 ? "hidden" : "auto", overflowY: "hidden", WebkitOverflowScrolling: "touch",
        ...(ovf && fitW && fitZ < 1 ? { zoom: fitZ } : {}),
      }}>
        {repMode === "weekly" && (
          <div>
            {isOwner && (
...
const NAWI_COLS = [{"n":"عربة التدخل في حوادث المواد الخطرة","p":["اوم4965","سبي705","اهو7367","اقس6823"]},{"n":"عربة التدخل في حوادث الانهيارات","p":["اصم3985","اصم3992"]},{"n":"الرافعات","p":["اقي7558","اقي7557"]},{"n":"سلالم|28","p":["صهط219","اصم3546"]},{"n":"سلالم|30","p":[]},{"n":"سلالم|32","p":["امن7536","امن7531","باق1802","باد8505","باد8473","اصم3047"]},{"n":"سلالم|52","p":["اار4625","ارر9193"]},{"n":"سلالم|56","p":["اكي8267"]},{"n":"سلالم|بيرس","p":["بحن213"]},{"n":"سنوركل","p":["حاب750","بمم335"]},{"n":"اطفاء الحرائق الصناعية","p":["اقي2545","اقي2546","بصا2622"]},{"n":"ونش سحب /8*8","p":["باد4513","بحق7112","الط1122","اعك7362"]},{"n":"صهريج المباني العالية","p":["بسع2827","بحق7105","بحق7103","بحق7117"]},{"n":"صهريج جبلي","p":[]},{"n":"انقاذ جبلي تويوتا","p":[]}];
  ...
  return (
    <div dir="rtl" className="app-shell" style={{ fontFamily: "'Tajawal',sans-serif", background: "#E5E8EC", minHeight: "100vh", color: "#1B2130", display: "flex", flexDirection: "column" }}>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 760px) {
          ...
          .side-rail button {
            ...
            gap: 6px; padding: 8px 1px 7px; border-radius: 9px; min-height: 56px;
          }
          .side-rail .rlb, .side-rail button > span:last-child {
            display: block; white-space: normal; overflow: visible; text-overflow: clip;
            font-size: 8.5px; line-height: 1.35; text-align: center; width: 100%; margin-bottom: 1px;
            word-break: keep-all; overflow-wrap: break-word;
          }
          .side-rail .ric { font-size: 16px; width: auto; line-height: 1; }
          .side-rail .ric-img img { height: 15px; }
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <nav className="app-nav" style={{ display: "flex", gap: 8, alignItems: "center", borderTop: "1px solid rgba(255,255,255,0.13)", paddingTop: 7, paddingBottom: 9, flexWrap: "wrap" }}>
            ...
            <span title="نسخة التطبيق الحالية" style={{
              alignSelf: "center", marginRight: 2, background: "linear-gradient(135deg,#FFD75E,#E8A81C)", color: "#3B2A00",
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 18, padding: "20px 22px", width: 520, maxWidth: "94%", maxHeight: "78vh", overflowY: "auto", boxShadow: "0 24px 70px rgba(0,0,0,0.4)" }}>
            ...
            {(db.trash || []).length === 0 ? (
              ...
              <div key={i} style={{ display: "flex", gap: 10, alignItems: "center", padding: "10px 4px", borderBottom: "1px solid #F0F2F7", fontSize: 12.5, flexWrap: "wrap" }}>
                <span style={{ background: e.k === "veh" ? "#FBE9EB" : "#EDE8FB", color: e.k === "veh" ? "#B3121C" : "#6D28D9", borderRadius: 8, padding: "3px 10px", fontWeight: 800, flexShrink: 0 }}>{e.k === "veh" ? <><VIcon /> آلية</> : "📟 حادث"}</span>
      ...
      {cmdOpen && (() => {
        ...
        const pages = [["overview", "نظرة عامة", "🏠"], ["readiness", "الجاهزية الميدانية", "📋"], ["list", "سجل الآليات", <VIcon key="v" />],
          ["dashboard", "لوحة المعلومات", "📊"], ["charts", "المؤشرات والتحليلات", "📈"], ["decision", "مركز القرار", "🎯"],
          ["ops", "إحصائيات عملياتية", "📟"], ["reports", "التقارير والبيانات", "🖨️"]]
          ...
          <div className="modal-overlay no-print" onClick={() => setCmdOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(10,14,24,0.55)", zIndex: 900, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "9vh 14px 0", backdropFilter: "blur(3px)" }}>
            <div className="modal-card" onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 16, width: "min(620px,100%)", maxHeight: "76vh", overflow: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.35)", padding: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                ...
                {pages.map(([id, l, pic]) => <Row key={id} ic="➜" t1={<>{pic} {l}</>}
